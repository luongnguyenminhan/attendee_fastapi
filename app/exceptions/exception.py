...
class UnauthorizedException(CustomHTTPException):
    ...
    def __init__(self, message: str = "Unauthorized access", detail: Optional[Any] = None):
...
class ExternalServiceException(CustomHTTPException):
    ...
    def __init__(self, message: str = "External service error", detail: Optional[Any] = None):
        super().__init__(
            message=message,
