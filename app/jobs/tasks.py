...
def process_meeting_recording(
    bot_id: int, recording_data: Dict[str, Any]
) -> Dict[str, Any]:
...
def send_webhook_notification(
    ...
    try:
        ...
        return {"status": "failed", "error": str(e), "sent_at": time.time()}
...
@celery_app.task
def join_meeting_task(
    bot_id: int, meeting_url: str, settings: Dict[str, Any]
) -> Dict[str, Any]:
