...
class Settings(BaseSettings):
    ...
    DATABASE_URL: str = "mysql+pymysql://admin:11minhan@mysql:3306/attendee_fastapi_db"
    ASYNC_DATABASE_URL: str = "mysql+pymysql://admin:11minhan@mysql:3306/attendee_fastapi_db"
