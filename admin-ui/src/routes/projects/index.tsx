    ...
    <div class="space-y-4 sm:space-y-6">
      ...
      <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p class="text-sm sm:text-base text-gray-600 mt-1">Quản lý dự án và API keys</p>
        </div>
      ...
      <Card>
        <CardBody class="text-center py-16">
          <FaIcon icon={faFolder} class="h-16 w-16 text-gray-400 mx-auto mb-4" />
          <h3 class="text-lg font-medium text-gray-900 mb-2">Projects API Coming Soon</h3>
          <p class="text-gray-500 mb-4">
            Projects management features are being developed.<br/>
