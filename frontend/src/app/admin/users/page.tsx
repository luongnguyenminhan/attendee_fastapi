    ...
    <AdminLayout>
      ...
      <div className="card bg-white rounded-lg shadow p-6 mb-8">
        <div className="flex justify-between items-center mb-4">
          <h3 className="font-bold text-lg text-[var(--primary)]">Users List</h3>
          <button className="btn-admin bg-[var(--primary)] text-white px-4 py-2 rounded hover:bg-blue-700">Add User</button>
        </div>
