// page.tsx (Admin Transcriptions page)
import AdminLayout from "../../layouts/AdminLayout";

export default function AdminTranscriptionsPage() {
  return (
    <AdminLayout>
      <h2 className="text-2xl font-bold mb-6">Transcriptions Management</h2>
      <div className="card bg-white rounded-lg shadow p-6 mb-8">
        <div className="flex justify-between items-center mb-4">
          <h3 className="font-bold text-lg text-[var(--primary)]">Transcriptions List</h3>
          <button className="btn-admin bg-[var(--primary)] text-white px-4 py-2 rounded hover:bg-blue-700">Add Transcription</button>
        </div>
        <div className="text-gray-500 text-center py-8">No transcriptions found.</div>
      </div>
      {/* Provider Statistics */}
